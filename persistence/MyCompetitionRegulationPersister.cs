    ...
    public class MyCompetitionRegulationPersister
    {
        ...
        private MemoryStream unzlib(string patch, int bitRecognized)
        {
            ...
            else if (bitRecognized == 1 || bitRecognized == 2)
            {
                ...
                UnzlibZlibConsole.UnzlibZlibConsole.CompetitionRegulation_toPc(memory1);
            }
        ...
        public void save(string patch, MemoryStream memoryCompetitionRegulation, int bitRecognized)
        {
            if (bitRecognized == 0)
            {
                //save zlib
            ...
            {
                UnzlibZlibConsole.UnzlibZlibConsole.zlib_memstream_to_console_xbox_overwriting(UnzlibZlibConsole.UnzlibZlibConsole.CompetitionRegulation_toConsole(memoryCompetitionRegulation), patch + PATH);
            }
            else if (bitRecognized == 2)
            {
                UnzlibZlibConsole.UnzlibZlibConsole.zlib_memstream_to_console_ps3_overwriting(UnzlibZlibConsole.UnzlibZlibConsole.CompetitionRegulation_toConsole(memoryCompetitionRegulation), patch + PATH);
            }
        }
    }
}
